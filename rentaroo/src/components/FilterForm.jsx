    ...
    <form>
      <div className="filter-form">
        <div className="filter-row">
          <label className = "categorytitle"  htmlFor="minPrice">Minimum Daily Rental Price:</label>
          <input
            type="number"
            name="minPrice"
            id="minPrice"
        ...
        <div className="filter-row">
          <label  className = "categorytitle"  htmlFor="maxPrice">Maximum Daily Rental Price:</label>
          <input
            type="number"
            name="maxPrice"
            id="maxPrice"
        ...
        <div className="filter-row">
          <label className = "categorytitle" htmlFor="types">Type of car:</label>
          <div className="types-checkboxes">
          <label htmlFor="car"><input
                type="checkbox"
                name="carType"
                value="car"
        ...
        <div className="filter-row">
          <label  className = "categorytitle"  htmlFor="categories">Category of car:</label>
          ...
          <div className="filter-row">
            <label  className = "categorytitle"  htmlFor="location">Location:</label>
