    ...
    <div className="vehicle-card">
      ...
      <div className="vehicle-details">
        ...
        {additionalInfoVisible && (
          ...
          <button className="select-button" onClick={handleCloseButtonClick}>Hide Additional Information</button>

          <button className="select-button" onClick={handleBookNowButtonClick}>Book Now</button>

          </>
        )}
        {!additionalInfoVisible && <button className="select-button" onClick={handleSelectButtonClick}>View Additional Information</button>}
      </div>
    </div>
  );
}
