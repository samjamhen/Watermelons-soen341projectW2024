        ...
        <div className="search-bar-branch">
          <div className="search-container">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="find-branch-button"
                disabled={!isAutocompleteSelected || formSubmitted}
              >
                Find Branch
              </button>
            </form>
        ...
        <div className="branches">
          <div className="flex-container">
            <div
              className="list-view"
              style={{
                display: showList && isAutocompleteSelected ? "block" : "none",
              }}
            >
            ...
            <div className="map-view">{showMap && <BranchMap />}</div>
          </div>
        </div>
      </div>
